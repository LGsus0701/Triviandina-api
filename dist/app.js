...
const pregunta_route_1 = __importDefault(require("./routes/pregunta.route"));
const app = (0, express_1.default)();
app.use((0, express_1.json)());
app.use('/api/v1/personas', persona_route_1.default);
app.use('/api/v1/categorias', categoria_route_1.default);
app.use('/api/v1/preguntas', pregunta_route_1.default);
exports.default = app;
